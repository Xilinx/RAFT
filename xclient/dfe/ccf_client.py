...
class CCF_Client(object):
    ...
    def XDfeCcf_GetCurrentCCCfgSwitchable(self, device_id, CCCfgDownlink, CCCfgUplink):
        ...
        CCCfgDownlink, CCCfgUplink = self.CCF.XDfeCcf_GetCurrentCCCfgSwitchable(device_id, CCCfgDownlink, CCCfgUplink)
    ...
    def XDfeCcf_SetNextCCCfgAndTriggerSwitchable(self, device_id, CCCfgDownlink, CCCfgUplink):
        ...
        self.logger.debug(f"XDfeCcf_SetNextCCCfgAndTriggerSwitchable({device_id}, "
                          f"{json.dumps(CCCfgDownlink, indent=2)}, "
                          f"{json.dumps(CCCfgDownlink, indent=2)})")
        ret, CCCfgDownlink, CCCfgUplink = self.CCF.XDfeCcf_SetNextCCCfgAndTriggerSwitchable(device_id, CCCfgDownlink, CCCfgUplink)
    ...
    def XDfeCcf_UpdateAntennaCfgSwitchable(self, device_id, AntennaCfgDownlink, AntennaCfgUplink):
        ...
        :return: ret - XST_SUCCESS if successful, XST_FAILURE if error occurs.
        """
        self.logger.debug(f"XDfeCcf_UpdateAntennaCfgDownlink({device_id}, "
						  f"{json.dumps(AntennaCfgDownlink, indent=2)}, "
						  f"{json.dumps(AntennaCfgUplink, indent=2)})")
        ret = self.CCF.XDfeCcf_UpdateAntennaCfgSwitchable(device_id, AntennaCfgDownlink, AntennaCfgUplink)
        self.logger.debug(f"ret = {ret}")
        return ret
    ...
    def XDfeCcf_SetRegBank(self, device_id, RegBank):
        ...
        self.CCF.XDfeCcf_SetRegBank(device_id, RegBank)
        return
    ...
    def XDfeCcf_GetIsCcfOperational(self, device_id):
        ...
        operational = self.CCF.XDfeCcf_GetIsCcfOperational(device_id)
        return operational
