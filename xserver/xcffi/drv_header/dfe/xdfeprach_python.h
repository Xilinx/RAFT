...
typedef struct {
	...
	XDfePrach_InternalCarrierCfg CarrierCfg[XDFEPRACH_CC_NUM_MAX]; /**< Array
...
typedef struct {
	...
	s32 NotUsedCCID; /**< Storage for 'Not used CCID' value */
	u32 SequenceLength; /**< Sequence length 'storage' */
